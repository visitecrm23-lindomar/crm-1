...
import { CheckCircle, Clock, AlertCircle, CreditCard, RefreshCcw } from "lucide-react";
    ...
    <div className="space-y-3 mt-4">
      <div className="space-y-2">
        {installments.map(inst => (
          <div key={inst.id} className="flex items-center justify-between p-3 bg-muted/50 rounded-lg border text-sm">
