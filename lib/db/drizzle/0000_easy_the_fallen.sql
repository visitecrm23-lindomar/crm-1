...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "hurb_bookings" (
        "id" text PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "hurb_integrations" (
        "id" text PRIMARY KEY NOT NULL,
        "store_id" text NOT NULL,
        "tenant_id" text NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "hurb_products" (
        "id" text PRIMARY KEY NOT NULL,
        "integration_id" text NOT NULL,
        "tenant_id" text NOT NULL,
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'passengers_reservation_id_reservations_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'reservations_tenant_id_tenants_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'reservations_trip_id_trips_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'reservations_client_id_clients_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'reservations_created_by_id_users_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'expenses_tenant_id_tenants_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'expenses_trip_id_trips_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'expenses_created_by_id_users_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'payments_tenant_id_tenants_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'payments_reservation_id_reservations_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'payments_client_id_clients_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'deals_tenant_id_tenants_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'deals_stage_id_pipeline_stages_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'deals_client_id_clients_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'deals_trip_id_trips_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'deals_owner_id_users_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'pipeline_stages_tenant_id_tenants_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'pipelines_tenant_id_tenants_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'store_categories_store_id_stores_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'store_coupons_store_id_stores_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'store_order_items_order_id_store_orders_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'store_order_items_product_id_store_products_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'store_orders_store_id_stores_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'store_orders_client_id_clients_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'store_pages_store_id_stores_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'store_products_store_id_stores_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'store_products_category_id_store_categories_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'store_products_trip_id_trips_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'store_reviews_store_id_stores_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'store_reviews_product_id_store_products_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'store_reviews_client_id_clients_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'stores_tenant_id_tenants_id_fk') THEN
...
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'hurb_bookings_integration_id_hurb_integrations_id_fk') THEN
    ALTER TABLE "hurb_bookings" ADD CONSTRAINT "hurb_bookings_integration_id_hurb_integrations_id_fk" FOREIGN KEY ("integration_id") REFERENCES "public"."hurb_integrations"("id") ON DELETE cascade ON UPDATE no action;
  END IF;
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'hurb_bookings_client_id_clients_id_fk') THEN
    ALTER TABLE "hurb_bookings" ADD CONSTRAINT "hurb_bookings_client_id_clients_id_fk" FOREIGN KEY ("client_id") REFERENCES "public"."clients"("id") ON DELETE no action ON UPDATE no action;
  END IF;
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'hurb_integrations_store_id_stores_id_fk') THEN
    ALTER TABLE "hurb_integrations" ADD CONSTRAINT "hurb_integrations_store_id_stores_id_fk" FOREIGN KEY ("store_id") REFERENCES "public"."stores"("id") ON DELETE cascade ON UPDATE no action;
  END IF;
END $$;--> statement-breakpoint
DO $$BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'hurb_products_integration_id_hurb_integrations_id_fk') THEN
